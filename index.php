    ...
    <nav class="navbar bg-mercadolibre">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="https://http2.mlstatic.com/frontend-assets/ui-navigation/5.17.0/mercadolibre/logo__large_plus.png" alt="Logo" class="img-fluid logo">
            </a>
        </div>
    </nav>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled">
                                <li>Dispositivo desbloqueado para que elijas la compañia telefónica que prefieras.<li>
                                <li>Compatible con redes 5G.</li>
                                <li>Pantalla Dynamic AMOLED 2X de 6.7".</li>
                                <li>3 cámaras traseras de 50Mpx/12Mpx/10Mpx.</li>
                                <li>This may still come in handy in some situations.</li>
                            </ul>
                            <form method="post" action="index.php">
                                <div class="mb-3">
                                    <label for="cantidad" class="form-label">Cantidad:</label>
                                    <select id="cantidad" name="cantidad" clas="fomr-select form-secelct-sm" aria-label="small select-excemple">
                        ...
                        <div class="card-footer text-body-secondary fw-bold text-end">
                            <div>Cantidad : <span class="text-primary"><?php echo $cantidad; ?></span></div>
                            <div>Total : <span class="text-primary">$<?php echo number_format($total, 2); ?></span></div>
                        </div>
                    </div>
                </div>
            </div>
